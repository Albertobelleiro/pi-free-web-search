...
- [ ] Write package manifest and Pi manifest
- [ ] Add TypeScript config and scripts
- [ ] Add OSS license and README
...
- [ ] Define browser, engine, config, search result, and extraction types
- [ ] Implement project/user config loading and merge logic
...
- [ ] Implement default browser detection for macOS and Linux
- [ ] Implement browser executable resolution
- [ ] Implement search engine detection from Safari/Chromium-family/Firefox preferences where possible
- [ ] Add parser tests for detection helpers
...
- [ ] Implement search URL builders and engine normalization
- [ ] Implement SERP HTML parsers for supported engines
- [ ] Implement quality scoring, dedupe, and domain filtering
...
- [ ] Implement Playwright browser launch with visible/headless policy
- [ ] Implement browser-based result extraction fallback
- [ ] Implement search orchestration and fallback thresholds
...
- [ ] Implement HTTP fetch + readability extraction
- [ ] Implement browser-rendered fallback extraction
- [ ] Convert extracted content to markdown-like output
...
- [ ] Register `free_web_search` tool
- [ ] Register `free_fetch_content` tool
- [ ] Add `/free-search-info` command
- [ ] Add `/free-search-test` command
- [ ] Add startup status indicator and user-facing skill
...
- [ ] Run smoke test against live web targets
